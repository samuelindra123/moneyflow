...
import { Mail, Code, Terminal, Heart } from 'lucide-react';

export function AboutDeveloper() {
  return (
    <section id="about-developer" className="py-32 md:py-44 bg-white relative overflow-hidden">
      {/* Background patterns */}
      <div className="absolute inset-0 -z-10">
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-orange-50/20 rounded-full blur-3xl" />
        <div className="absolute top-0 left-0 w-96 h-96 bg-indigo-50/10 rounded-full blur-3xl" />
      </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-slate-50 border border-slate-200/80 rounded-3xl p-8 w-72 sm:w-80 shadow-xl shadow-slate-100/50 overflow-hidden">
                ...
                <div className="text-center space-y-1">
                  <h4 className="text-lg font-serif font-bold text-slate-900">Samuel Indra</h4>
                  <p className="text-xs text-[#CC5A37] font-semibold">Independent Creator</p>
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-serif font-light text-slate-900 tracking-tight leading-tight">
              Dibuat untuk memudahkan hidup kita bersama
            </h2>

            <div className="space-y-4 text-slate-500 font-light leading-relaxed text-base">
              <p>
                Halo! Saya <strong>Samuel Indra</strong>. Saya membangun MoneyFlow karena merasa lelah mencari aplikasi pencatatan keuangan pribadi yang beneran cocok. Kebanyakan aplikasi di luar sana terlalu rumit, dipenuhi iklan yang mengganggu, atau membatasi fitur dasar seperti sinkronisasi cloud.
              </p>
              <p>
                MoneyFlow dirancang sebagai <strong>proyek personal</strong> yang bertujuan menyediakan ruang pencatatan keuangan yang bersih, aman, gratis, dan super intuitif bagi siapa saja. Tidak ada tujuan komersial besar—ini murni produk kecil yang saya kembangkan untuk membantu saya (dan semoga, kamu juga) mengelola keuangan sehari-hari dengan lebih rileks.
              </p>
            </div>
